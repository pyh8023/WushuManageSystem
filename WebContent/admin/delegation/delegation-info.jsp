    ...
    <div class="row">
		    ...
		    <nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm">
		      <ul class="nav bs-docs-sidenav sidebar_ul">
		      	<li id="active_li"><a href="delegation-info.html">代表团信息</a></li>
		      	<li><a href="delegation-member.html">代表团成员</a></li>
		      	<li><a href="delegation-competition-info.html">参赛项目</a></li>
		      </ul>
		    </nav>
		 	</div>
			
			<div class="col-md-5 col-md-offset-1" role="main" id="content">
				<form class="form">
					  ...
					  <div class="form-group">
					    <label for="delegation_main_coach" class="control-label">主教练</label>
					    <div>
					    	<input type="text" class="form-control" id="delegation_main_coach" placeholder="请输入主教练姓名" required>
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="delegation_athlet_num" class="control-label">运动员人数</label>
					    <div>
					    	<input type="number" class="form-control" id="delegation_athlet_num" placeholder="请输入运动员人数" required>
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="delegation_member_num" class="control-label">成员总人数</label>
					    <div>
					    	<input type="number" class="form-control" id="delegation_member_num" placeholder="请输入成员总人数" required>
					    </div>
					  </div>
					  <div class="form-group">
