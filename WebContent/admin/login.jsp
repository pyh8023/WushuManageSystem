...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container-fluid col-md-4 col-md-offset-4">
		<form id="form_login" action="login.action" method="post">
    ...
    <script type="text/javascript">
	    function reloadImage(){
	        document.getElementById("identity").src = "../image.jsp?"+Math.random(); //Math.random()方法非常重要，它使每次的请求都不同以便重新发送。如果每次的请求都一样，那么不会重新生成页面
	      } 
    </script>
  </body>
</html>